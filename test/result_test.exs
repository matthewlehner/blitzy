defmodule BlitzyResultTest do
  ...
  test "calc stats" do
    input = [{:ok, 0.083, 200, 1483802531706, "get"},{:ok, 0.083, 200, 1483802531706, "get"},{:ok, 0.083, 200, 1483802531706, "get"},{:error, 0.04, 500, 1483802531706, "get"}]
    assert calc_stats(input,4) == {4, 4, 3, 1, 0.083, 0.083, 0.083}
  end
  test "calc stats all errors" do
    input = [{:error, 0.083, 200, 1483802531706, "get"},{:error, 0.083, 200, 1483802531706, "get"},{:error, 0.083, 200, 1483802531706, "get"},{:error, 0.04, 500, 1483802531706, "get"}]
    assert calc_stats(input,4) == {4, 4, 0, 4, 0, 0, 0}
  end
  test "parse results" do
    input = [[{:ok, 0.083, 200, 1483802531706, "get"},{:ok, 0.083, 200, 1483802531706, "get"}],{:ok, 0.083, 200, 1483802531706, "get"},{:error, 0.04, 500, 1483802531706, "get"}]
    assert parse_results(input,4) == [{:ok, 0.083, 200, 1483802531706, "get"},{:ok, 0.083, 200, 1483802531706, "get"},{:ok, 0.083, 200, 1483802531706, "get"},{:error, 0.04, 500, 1483802531706, "get"}]
  end
end
